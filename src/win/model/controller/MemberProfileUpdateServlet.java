...
public class MemberProfileUpdateServlet extends HttpServlet {
     ...
     */
    public MemberProfileUpdateServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int maxSize = 1024 * 1024 * 10; // 10MB
	     ...
	     Member mem = new Member();
	      ...
	      mem.setFilepath(savePath);
	      mem.setChangename(saveFile);
          mem.setNo(no);
          mem.setMemberType(memberType);
          
          m.setChangename(saveFile);
          
       try {
		int result =  ms.updateProfileMember(mem);
