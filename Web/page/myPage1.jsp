            ...
            <div class="sidebar">
              <div class="developer_name_tag">
                    <h3 class="developer_heading"> 개발자 
                        <a onclick='return del();'><img src="/win/images/delete.png" class="main_img"></a>
                  ...
                  <section class="mypage_technologys">
                                        ...
                                        <div style="display:content;">
                                            ...
                                            <div>
                                                ...
                                                <p class="mypage_info_ment">등록된 보유 기술이 없습니다.</p>
                                                 ...
                                                 <%}else {%>
                                                 <h4 class="technology_title">보유 기술<a class="technology_button" href="/win/page/mypagetechnology.jsp">수정하기</a></h4>
				                                <div class="technology_container">
				                                    <div class="technology_content">
				                                        <div style="display:content;">
                    ...
                    <section class="mypage_careers">
                        <div class="mypage_career">
                            <div>
                              <%if (clist.isEmpty()) {%>
                                <h4 class="career_title">경력
                                <a class="career_button" href="/win/page/mypagecareer.jsp">업데이트 하기</a></h4>
                                <%} else{%>
                                 <h4 class="career_title">경력
                                <a class="career_button" href="/win/page/mypagecareer.jsp">수정하기</a></h4>
                                <% }%> 
