    ...
    <div class="page">
        <div class="page_inner">
            <div class="sidebar">
                ...
                <!-- <div class="sidebar_bottom">
                    <ul class="sidebar_bot">
                        <li class="sidebar_list"><a href="/win/page/survey.jsp"  class="sidebar_info">평가</a></li>
                    </ul>
                </div>

                <div class="sidebar_bottom">
                    <ul class="sidebar_bot">
                        <li class="sidebar_list"><a href="/win/page/surveycommit.jsp"  class="sidebar_info">평가등록</a></li>
                    </ul>
                </div> -->
            </div>
                    ...
                    <div class="mypCotent">
                        <div class="title_div">
                            ...
                            <div class="btn">
                                ...
                                <a href="/win/page/myPage1.jsp" class="submit_btn"><button class="submit_btn" type="button">취소</button></a>
                            </div>
                        </div>
                    </div>
                </div>
