                ...
                <div class="write_main">
                    ...
                    <div class="mypCotent">
                        <div class="title_div">
                            ...
                            <input class="title_input" id="tInput" name="title" type="text" >
                        </div>
                        ...
                        <div class="sub_btn">
                            ...
                            <a href="/win/page/mypage_company.jsp" class="cancel_btn"><button type="reset" name="cancel" class="cancel_btn">취소</button></a>
                        </div>
                    </div>
