...
<%@include file="header.jsp" %>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4"style="width:100%;height:100%;">
            <h1 class="h3 mb-0 text-gray-800">유입률</h1>
          ...
          <div style="width:1200px;height:400px;">
            ...
            <!-- Content Column -->
              ...
              <div class="card shadow mb-4" style="margin-left:30px">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">구글 아날리틱스</h6>
                </div >
                
                  <input type="image" src="/win/images/google.gif" alt="유입률" style="width:100%;height:100%;">
